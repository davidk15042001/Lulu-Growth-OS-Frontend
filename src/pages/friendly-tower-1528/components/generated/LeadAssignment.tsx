...
const leads = [['Sarah Johnson', 'Bosch GmbH', 'Web Form', 'Manufacturing', 'Germany', '87', '2h ago', 'Maria Chen', 'New'], ['Marcus Weber', 'Siemens AG', 'LinkedIn', 'Technology', 'Germany', '92', '4h ago', 'David Miller', 'New'], ['Elena Rossi', 'Ferrari SpA', 'Referral', 'Automotive', 'Italy', '78', '5h ago', 'Anna Schmidt', 'New'], ['Thomas Berg', 'SAP SE', 'Demo Request', 'Software', 'Germany', '94', '6h ago', 'Maria Chen', 'Hot'], ['Claire Dubois', 'Airbus', 'Trade Show', 'Aerospace', 'France', '71', '1d ago', '—', 'New'], ['Raj Patel', 'Tata Consultancy', 'API', 'IT Services', 'India', '65', '1d ago', '—', 'New']];
...
const reps = [['Maria Chen', '287', '34', '82.1', '85%', '24.1%'], ['David Miller', '312', '41', '79.4', '92%', '26.2%'], ['Anna Schmidt', '198', '22', '77.8', '72%', '16.6%'], ['Tom Wagner', '245', '29', '80.2', '88%', '20.6%'], ['Lisa Park', '147', '18', '75.6', '61%', '12.3%']];
...
const history = [['Sarah Johnson', 'Unassigned', 'Maria Chen', 'Automatic', 'Enterprise Germany', 'System', '2h ago'], ['Thomas Berg', 'Unassigned', 'David Miller', 'Automatic', 'Strategic Accounts', 'System', '6h ago'], ['Marcus Weber', 'Maria Chen', 'David Miller', 'Manual', '—', 'John Hayes', '3h ago'], ['Elena Rossi', 'Unassigned', 'Anna Schmidt', 'AI-assisted', '—', 'Lulu AI', '5h ago']];
