...
const capabilityRows = [
  ["View dashboards, reports and connected data", true, true],
  ["Manage workspace content and settings", true, true],
  ["Manage connected websites and platforms", true, true],
  ["Automatic AI analysis and statistics", true, true],
  ["SEO, GEO, AEO and Website automation", true, true],
] as const;
...
export function DashboardBilling() {
  ...
  const choosePlan = async () => {
    ...
    try {
      const response = await onboardingApi.createBillingCheckout(selectedWorkspace.id, { planKey: selectedPlan, successUrl: `${window.location.origin}${window.location.pathname}?payment=success`, backUrl: `${window.location.origin}${window.location.pathname}?payment=cancelled` });
