...
type ActivityKpi = { label: string; value: string; delta: string; icon: ComponentType<{ size?: number }>; tone: string };
...
function Sidebar({
  ...
  const main: Array<Record<string, any>> = [];
