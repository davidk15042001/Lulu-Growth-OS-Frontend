...
function Sidebar() {
  return <aside className="sidebar"><div className="brand"><span className="brand-mark"><Sparkles size={16} /></span><strong>LULU</strong><span className="brand-ai">AI</span></div><div className="workspace"><span className="workspace-dot" /> <span>Acme Corporation</span><ChevronDown size={14} /></div><LuluSectionNavigation activeId="nice-year-6253" /><div className="sidebar-bottom"><a className="nav-item"><Settings2 size={16} /><span>Workspace Settings</span></a><div className="user-row"><span className="user-avatar">AM</span><span><strong>Alex Morgan</strong><small>Administrator</small></span><Ellipsis size={16} /></div></div></aside>;
}
function StatusPill({
  status,
  sync = false
