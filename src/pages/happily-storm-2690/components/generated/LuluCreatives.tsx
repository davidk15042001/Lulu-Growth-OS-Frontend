...
export function LuluCreatives() {
  ...
  return <div className="lulu-shell">
    ...
    <aside className="sidebar"><div className="brand"><div className="brand-mark"><Sparkles size={17} /></div><span>Lulu <b>AI</b></span></div><div className="workspace"><div className="workspace-avatar">AC</div><div><strong>Acme Corporation</strong><small>Business OS</small></div><ChevronDown size={15} /></div><LuluSectionNavigation activeId="happily-storm-2690" /><div className="sidebar-bottom"><button className="nav-item"><Settings2 size={17} /><span>Settings</span></button><div className="user"><div className="user-avatar">JD</div><div><strong>Jordan Davis</strong><small>Administrator</small></div><MoreHorizontal size={16} /></div></div></aside>
