...
export const LuluForecasts = () => {
  ...
  const { items: forecastRecords, loading, error, refresh: refreshForecasts } = useLiveRecords('forecasts');
  const refresh = () => {
