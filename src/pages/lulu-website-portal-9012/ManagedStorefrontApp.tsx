...
export const TEMPLATE_UI: Record<TemplateLocale, {
  ...
  zh: {
    ...
    company: "标准紧固件", companyBody: "浏览工业应用所需的螺栓、螺母、地脚螺栓及各类螺纹紧固件。", offer: "批发供应", offerBody: "混合规格、批量采购和完整项目供应。", trustTitle: "技术评审", trustBody: "根据确认范围核查规格、图纸和质量要求。", contactTitle: "提交询价", contactBody: "分享产品清单、尺寸、BOM或图纸，直接开始沟通。",
...
function placeholderCopy(locale: TemplateLocale): TemplateCopy {
  ...
  return { ...base, ...content } as TemplateCopy;
}
