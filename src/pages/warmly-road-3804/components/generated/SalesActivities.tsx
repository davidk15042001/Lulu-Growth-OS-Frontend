...
const activities = [['Executive Follow-up', 'Call', 'Scheduled', 'Today · 14:30', 'Sales team member', 'Maria Chen', 'Nova Commerce', 'Enterprise Expansion', 'Enterprise Platform', 'High'], ['Q3 Partnership Review', 'Meeting', 'In Progress', 'Today · 11:00', 'Sarah Kim', 'James Wilson', 'Connected account', 'Strategic Alliance', 'Enterprise Suite', 'High'], ['Proposal Walkthrough', 'Demo', 'Scheduled', 'Tomorrow · 10:00', 'Marcus Lee', 'Ana Souza', 'Global Retail', 'Retail Platform', 'Commerce Pro', 'Medium'], ['Contract Follow-up', 'Follow-up', 'Overdue', 'Yesterday · 15:00', 'Sales team member', 'Tom Hughes', 'Peak Ventures', 'Series B Expansion', 'Venture Pack', 'High', 'No Response'], ['Intro Discovery Call', 'Call', 'Completed', '2 days ago', 'Sarah Kim', 'Lisa Park', 'BlueSky Tech', 'Cloud Migration', 'Cloud Starter', 'Medium', 'Connected'], ['Pricing Negotiation', 'Negotiation', 'Scheduled', '28 Jun · 16:00', 'Marcus Lee', 'Raj Patel', 'Apex Corp', 'Enterprise Renewal', 'Enterprise Max', 'High'], ['Solution Proposal Email', 'Email', 'Sent', '27 Jun', 'Sales team member', 'Claire Dubois', 'Luminar Group', 'Expansion Deal', 'Pro Suite', 'Medium', 'Opened'], ['Post-Demo Follow-up', 'Follow-up', 'Scheduled', '29 Jun', 'Sarah Kim', 'Kevin Park', 'Meridian Inc', 'Platform Demo', 'Starter Plus', 'Low'], ['Internal Briefing Note', 'Note', 'Completed', '25 Jun', 'Marcus Lee', '—', 'Nova Commerce', '—', '—', 'Low', 'Recorded'], ['Contract Review Meeting', 'Meeting', 'Completed', '24 Jun · 09:00', 'Sales team member', 'Maria Chen', 'Nova Commerce', 'Enterprise Expansion', 'Enterprise Platform', 'High', 'Meeting Scheduled']];
const overdue = [['Contract Follow-up', 'Sales team member', 'Peak Ventures', 'Venture Pack', 'Yesterday · 15:00', '1 day', 'High'], ['Renewal Check-in', 'Sarah Kim', 'Connected account', 'Enterprise Suite', '25 Jun · 10:00', '4 days', 'High'], ['Send Usage Report', 'Marcus Lee', 'BlueSky Tech', 'Cloud Starter', '24 Jun · 16:00', '5 days', 'Medium']];
const owners = [['Sales team member', '74', '58', '9', '7', '78%'], ['Sarah Kim', '63', '49', '10', '4', '78%'], ['Marcus Lee', '59', '43', '8', '8', '73%'], ['Jennifer Wu', '52', '39', '7', '6', '75%']];
const upcoming = [['14:30', 'Executive Follow-up', 'Maria Chen', 'Sales team member', 'High'], ['16:00', 'Pricing Negotiation', 'Raj Patel', 'Marcus Lee', 'High'], ['17:15', 'Post-Demo Follow-up', 'Kevin Park', 'Sarah Kim', 'Low'], ['10:00', 'Proposal Walkthrough', 'Ana Souza', 'Marcus Lee', 'Medium'], ['13:30', 'Q3 Partnership Review', 'James Wilson', 'Sarah Kim', 'High']];
...
const recommendations: {
  ...
  detail: 'Connected account contract overdue',
  icon: Bell
}, {
