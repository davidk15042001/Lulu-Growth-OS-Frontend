...
const platforms: Platform[] = [{
  ...
  status: 'Recommended',
  reason: 'High purchase intent, strong historical conversion. CPL — average.',
  confidence: 94,
...
export function LuluCampaignBuilder() {
