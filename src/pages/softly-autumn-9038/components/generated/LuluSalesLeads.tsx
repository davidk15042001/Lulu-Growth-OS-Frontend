...
export function LuluSalesLeads() {
  ...
  const { items: liveLeads, loading: liveLoading, error: liveError } = useLiveRecords('sales_leads');
  const liveEmpty = !liveLoading && !liveError && liveLeads.length === 0;
