...
export function StorePerformancePage() {
  ...
  return <main className="min-h-screen bg-[var(--background)] text-foreground">
    ...
    <div className="lg:pl-[248px]"><div className="mx-auto max-w-[1540px] px-5 py-5 sm:px-8 lg:px-10">
      ...
      <footer className="border-t border-border py-6 text-center text-xs text-muted-foreground">Illustrative sample values · Observed platform data, Calculated metrics, AI Insight and AI Forecast are clearly labeled.</footer>
    </div></div>
  </main>;
}
