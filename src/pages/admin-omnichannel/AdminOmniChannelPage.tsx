...
export default function AdminOmniChannelPage(){
  ...
  return <main className="lulu-admin-standalone lulu-admin-omnichannel page-frame min-h-screen bg-[var(--background)] px-4 py-6 sm:px-6 lg:px-8"><div className="mx-auto max-w-[1500px] space-y-6">
