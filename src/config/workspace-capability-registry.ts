...
const EMPLOYEE_WORKSPACE_PAGE: Readonly<Record<string, string>> = {
  ...
  "email-specialist": "email-inbox",
  "calendar-coordinator": "calendar-overview",
  "brand-content-strategist": "website-posts-9016",
  ...
  "pages-cms-manager": "website-pages-cms-9015",
  "reviews-reputation-manager": "daring-brook-9034",
  "search-visibility-manager": "sparklingly-moon-5114",
