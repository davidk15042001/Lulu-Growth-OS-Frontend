...
function Detail({ kind, item, detail, onSend, canWrite }: { kind: Kind; item: Quote | Invoice; detail: Record<string, unknown>; onSend: () => void; canWrite: boolean }) {
  const t = useTranslation();
