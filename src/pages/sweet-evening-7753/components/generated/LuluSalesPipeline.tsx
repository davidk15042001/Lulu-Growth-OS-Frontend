    ...
    <div className="flex min-h-screen">
      <aside className="hidden w-[232px] shrink-0 border-r border-border bg-[var(--sidebar)] px-4 py-5 lg:block">
        ...
        <nav className="space-y-1" aria-label="Main navigation">
          {['Overview', 'Inbox', 'Accounts', 'Contacts'].map(item => <button key={item} className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm text-foreground hover:bg-secondary hover:text-foreground"><LayoutDashboard size={16} /><span>{item}</span></button>)}
          <div className="mt-5 px-3 pb-2 text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Revenue</div>
          <button className="flex w-full items-center justify-between rounded-lg bg-secondary/15 px-3 py-2.5 text-left text-sm font-medium text-foreground"><span className="flex items-center gap-3"><BriefcaseBusiness size={16} /><span>Sales</span></span><ChevronDown size={14} /></button>
          <div className="ml-7 space-y-1 border-l border-border/20 pl-3"><button className="w-full rounded-md px-2 py-2 text-left text-sm text-foreground">Pipeline</button><button className="w-full rounded-md px-2 py-2 text-left text-sm text-foreground hover:text-foreground">Forecast</button><button className="w-full rounded-md px-2 py-2 text-left text-sm text-foreground hover:text-foreground">Activities</button></div>
          {['Marketing', 'Service', 'Reports'].map(item => <button key={item} className="mt-1 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm text-foreground hover:bg-secondary hover:text-foreground"><BarChart3 size={16} /><span>{item}</span></button>)}
        </nav>
