...
const platformGroups: PlatformGroup[] = [
  ...
  { id: 'marketing', label: 'Marketing & Analytics', description: 'Connect advertising, analytics and business-profile platforms for verified performance data.', icon: BarChart3, platforms: ['Google Ads API', 'Google Analytics', 'Meta Marketing API', 'Meta Conversion API', 'LinkedIn Ads Advertising API', 'LinkedIn Conversion Tracking API', 'TikTok Ads', 'Google Business'], comingSoonPlatforms: ['Google Ads API', 'Google Analytics', 'Meta Marketing API', 'Meta Conversion API', 'LinkedIn Conversion Tracking API', 'TikTok Ads', 'Google Business'] },
