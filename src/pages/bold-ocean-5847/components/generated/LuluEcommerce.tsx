...
export function LuluEcommerce() {
 ...
 <aside className="side fixed inset-y-0 left-0 flex w-14 flex-col items-center gap-7 bg-[var(--sidebar)] py-6 text-foreground"><strong className="text-lg text-[var(--foreground)]">L</strong><LayoutDashboard size={17} /><LineChart size={17} /><ShoppingBag size={17} /><Users size={17} /><Globe2 size={17} /><Bell size={17} /><Settings size={17} /></aside>
 <main className="main ml-14 px-12 py-7"><header><nav className="text-xs text-[var(--muted-foreground)]">Intelligence <span className="mx-2 text-[var(--muted-foreground)]">/</span> Business Intelligence <span className="mx-2 text-[var(--muted-foreground)]">/</span> Ecommerce</nav><div className="mt-4 flex items-start justify-between gap-6"><div><h1 className="text-[28px] font-bold tracking-[-.03em]">Ecommerce</h1><p className="mt-1 max-w-2xl text-[15px] text-[var(--muted-foreground)]">Understand your store performance, customers, products, orders and revenue across every connected ecommerce channel.</p></div><div className="actions flex shrink-0 gap-2"><button className="flex h-8 items-center gap-1.5 rounded-md bg-[var(--primary)] px-3 text-xs font-semibold text-primary-foreground"><Sparkles size={13} /> Ask Lulu AI</button><button className="flex h-8 items-center gap-1.5 rounded-md border border-[var(--muted-foreground)] bg-card px-3 text-xs"><RefreshCw size={13} /> Refresh</button><button className="flex h-8 items-center gap-1.5 rounded-md border border-[var(--muted-foreground)] bg-card px-3 text-xs"><span className="text-base">+</span> Create Report</button><button className="flex h-8 items-center gap-1.5 rounded-md border border-[var(--muted-foreground)] bg-card px-3 text-xs"><Download size={13} /> Export</button></div></div></header>
