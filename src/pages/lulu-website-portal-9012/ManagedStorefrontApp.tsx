...
const TEMPLATE_UI: Record<TemplateLocale, {
  ...
  productsTitle: string; productsBody: string; productImage: string; productLabel: string; priceOnRequest: string;
  ...
  de: {
    ...
    productsTitle: "Dein Shop-Bereich", productsBody: "Produktkarten erscheinen automatisch, sobald Produkte im zentralen Katalog freigegeben sind.", productImage: "Produktbild wird ergänzt", productLabel: "Produkt", priceOnRequest: "Preis auf Anfrage",
    strengthsLabel: "Kernstärken", strengthsTitle: "Eine Marke, die verständlich und verlässlich wirkt", strengthsBody: "Lulu verbindet deine echten Unternehmensdaten zu einer klaren, konsistenten digitalen Präsenz.", strengths: ["Klare Positionierung", "Verifizierte Inhalte", "Ein nachvollziehbarer Prozess"], serviceCards: ["Beratung und Lösungen", "Produkte und Services", "Individuelle Unterstützung", "Verlässliche Umsetzung"], companyImage: "Unternehmensbild wird ergänzt",
  ...
  en: {
    ...
    productsTitle: "Your shop area", productsBody: "Product cards appear automatically when products are approved in the central catalog.", productImage: "Product image will be added", productLabel: "Product", priceOnRequest: "Price on request",
    strengthsLabel: "Core strengths", strengthsTitle: "A brand that feels clear and reliable", strengthsBody: "Lulu turns your real company data into a clear, consistent digital presence.", strengths: ["Clear positioning", "Verified content", "A transparent process"], serviceCards: ["Advice and solutions", "Products and services", "Individual support", "Reliable execution"], companyImage: "Company image will be added",
  ...
  zh: {
    ...
    productsTitle: "你的商店区域", productsBody: "中央目录中的产品获批后会自动显示产品卡片。", productImage: "即将添加产品图片", productLabel: "产品", priceOnRequest: "价格咨询",
    strengthsLabel: "核心优势", strengthsTitle: "清晰可靠的品牌形象", strengthsBody: "Lulu 将真实的公司数据整理成清晰一致的数字形象。", strengths: ["清晰定位", "已验证内容", "透明流程"], serviceCards: ["咨询与解决方案", "产品与服务", "个性化支持", "可靠执行"], companyImage: "即将添加公司图片",
