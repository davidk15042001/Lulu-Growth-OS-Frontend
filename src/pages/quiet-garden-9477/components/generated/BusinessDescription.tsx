    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <section className="flex items-start justify-center px-6 py-8 sm:px-8 lg:px-12"><div className="w-full max-w-xl">
        ...
        <form className="mt-8 space-y-5 rounded-xl border border-[var(--border)] bg-[var(--card)] p-5 shadow-[0_20px_60px_rgba(0,0,0,0.08)]" onSubmit={saveAndContinue}>
          ...
          <div className="rounded-lg border border-[var(--border)] bg-[var(--secondary)] px-4 py-3 text-sm leading-6 text-[var(--muted-foreground)]">
            Detaillierte Positionierung wie Value Proposition, Target Market, Primary ICP, USP, Brand Description, Challenges und Languages bearbeitest du spaeter zentral unter <span className="font-medium text-[var(--foreground)]">AI → Knowledge</span>.
          </div>
