...
export const LuluCompetitors = () => {
  ...
  const { items: competitorRecords, loading: competitorsLoading, error: competitorsError } = useLiveRecords('marketing_competitors');
