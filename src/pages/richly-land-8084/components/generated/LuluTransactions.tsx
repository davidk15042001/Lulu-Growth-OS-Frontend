...
export function LuluTransactions() {
 ...
 <div className="mt-4 flex items-center justify-between"><div className="flex items-center gap-2 text-[11px] text-muted-foreground"><span className="h-2 w-2 animate-pulse rounded-full bg-primary text-primary-foreground" />Live synchronization status unavailable · <button className="font-semibold text-foreground">Refresh ↻</button></div><div className="flex items-center gap-2 text-xs text-muted-foreground"><span>Comparison:</span><button className="font-semibold text-foreground">Previous Period <ChevronDown size={13} className="inline" /></button></div></div>
