...
export const LuluBudgets = () => {
  ...
  const liveCategoryData: typeof categoryData = [];
  const liveChartData: typeof chartData = [];
  ...
  return <div className="min-h-screen bg-[var(--background)] text-foreground">
    ...
    {!liveLoading && liveBudgets.length === 0 && <div className="mx-5 mt-4 rounded-xl border border-dashed border-border p-8 text-center text-sm text-muted-foreground">No budget records are available yet. Add a budget or connect a finance platform.</div>}
        ...
        <div className="space-y-5 p-9">
          ...
          <section className="grid grid-cols-2 gap-3 xl:grid-cols-7"><div className="col-span-2 rounded-lg border border-dashed border-border bg-card p-6 text-center text-sm text-muted-foreground xl:col-span-7">Live budget KPIs will appear here when budget records are available.</div></section>
