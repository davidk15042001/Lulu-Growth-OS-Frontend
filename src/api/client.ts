...
const FRIENDLY_API_MESSAGES: Record<string, string> = {
  ...
  AD_SPEND_FUNDS_REQUIRED: "Paid advertising is paused until the advertising wallet is funded.",
  ...
  CALENDAR_PROVIDER_NOT_CONFIGURED: "This calendar provider is not configured on the server yet.",
  ...
  CALENDAR_ACCOUNT_LOOKUP_FAILED: "The connected calendar identity could not be loaded.",
