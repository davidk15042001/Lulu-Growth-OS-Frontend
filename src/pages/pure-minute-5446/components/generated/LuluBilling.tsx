  ...
  return <div className="min-h-screen bg-[var(--background)] text-foreground">
    ...
    <main className="mx-auto max-w-[1440px] px-4 py-6 sm:px-6 lg:ml-64 lg:px-10 lg:py-10">
      <header className="rounded-3xl border border-border bg-card p-6 shadow-sm sm:p-8">
        ...
        <nav aria-label="Billing areas" className="mt-7 grid gap-2 border-t border-border pt-5 sm:grid-cols-2 xl:grid-cols-5">
          ...
          <a href="#composio-usage" className="group flex items-center gap-3 rounded-xl border border-border bg-background px-3.5 py-3 transition hover:border-primary/40 hover:bg-secondary"><span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-fuchsia-500/10 text-fuchsia-700"><Sparkles size={15} /></span><span><strong className="block text-sm">Composio</strong><span className="text-xs text-muted-foreground">Tool calls & triggers</span></span></a>
