...
export const LuluIntelligenceOverview = () => {
  ...
  const { items: insightRecords, loading: insightsLoading, error: insightsError } = useLiveRecords('ai_insights');
  const getInsightField = (record: typeof insightRecords[number], key: string) => String((record as unknown as Record<string, unknown>)[key] ?? '');
