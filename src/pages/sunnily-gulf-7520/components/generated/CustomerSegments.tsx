  ...
  return <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <div className="flex min-h-screen">
        <aside className="hidden w-[236px] shrink-0 flex-col bg-[var(--sidebar)] text-foreground lg:flex">
          ...
          <div className="px-4 pt-7"><p className="px-3 text-[10px] font-bold uppercase tracking-[.2em] text-muted-foreground">Workspace</p><LuluSectionNavigation activeId="sunnily-gulf-7520" /></div>
