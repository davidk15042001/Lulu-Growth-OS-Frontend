...
const detected: Detected[] = [{
  ...
  title: 'Advertising efficiency weakened',
  impact: 'High',
  confidence: 91,
  time: '3h ago',
  ...
  title: 'Customer retention stabilized',
  impact: 'Medium',
  confidence: 87,
  time: '5h ago',
  sources: ['CRM'],
...
const tasks: Task[] = [{
  task: 'Audit Meta Ads campaign performance',
  ...
  task: 'Analyze high-LTV customer segment',
  source: 'AI Insight',
  priority: 'Medium',
  status: 'Suggested',
  owner: '—',
  ...
  task: 'Review advertising budget allocation',
  source: 'AI Recommendation',
  priority: 'High',
  status: 'In Progress',
  owner: 'Marketing',
  ...
  return <div className="min-h-screen bg-[var(--background)] text-foreground">
      <aside className={`${mobileMenu ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 left-0 z-30 flex w-[248px] flex-col bg-[var(--sidebar)] text-foreground transition-transform lg:translate-x-0`}>
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-5" aria-label="Primary navigation">
          ...
          <button className="mb-1 flex w-full items-center gap-3 rounded-lg bg-secondary/15 px-3 py-2.5 text-left text-sm font-semibold text-foreground"><Brain size={17} />Intelligence</button>
          {navOpen && <div className="ml-4 border-l border-border pl-3"><a className="mb-1 block rounded-md bg-secondary px-3 py-2 text-xs font-semibold text-foreground" href="#overview">Intelligence Overview</a><a className="block px-3 py-2 text-xs hover:text-foreground" href="#health">Executive Overview</a><button className="flex w-full items-center justify-between px-3 py-2 text-xs text-foreground hover:text-foreground">Business Intelligence<ChevronDown size={13} /></button>{['Business Health', 'Growth', 'Revenue', 'Customers', 'Sales', 'Marketing', 'Advertising', 'Ecommerce', 'Finance', 'Operations', 'Products', 'AI Activity'].map(item => <a key={item} className="block px-3 py-1.5 text-xs text-foreground hover:text-foreground" href={`#${item.toLowerCase().replace(' ', '-')}`}>{item}</a>)}<button className="mt-1 flex w-full items-center justify-between px-3 py-2 text-xs text-foreground hover:text-foreground">Analytics<ChevronDown size={13} /></button>{['KPI Explorer', 'Reports', 'Comparisons', 'Benchmarks', 'Forecasts', 'Trends', 'Anomalies', 'Attribution'].map(item => <a key={item} className="block px-3 py-1.5 text-xs text-foreground hover:text-foreground" href="#analytics">{item}</a>)}<button className="mt-1 flex w-full items-center justify-between px-3 py-2 text-xs text-foreground hover:text-foreground">AI Intelligence<ChevronDown size={13} /></button>{['AI Insights', 'AI Recommendations', 'AI Tasks'].map(item => <a key={item} className="block px-3 py-1.5 text-xs text-foreground hover:text-foreground" href="#ai">{item}</a>)}</div>}
          <button onClick={() => setNavOpen(!navOpen)} className="mt-2 flex w-full items-center gap-3 px-3 py-2.5 text-sm text-foreground hover:text-foreground"><Layers3 size={17} />Collapse menu</button>
        </nav>
      ...
      <main className="min-w-0 lg:ml-[248px]">
        ...
        <div id="overview" className="mx-auto max-w-[1500px] px-4 py-7 md:px-8 lg:px-10">
          ...
          <section id="health" className="mb-9 grid gap-4 lg:grid-cols-2"><article className="rounded-xl border border-border bg-card p-5 shadow-sm"><SectionHeader title="Business Health" subtitle="A balanced read of business momentum." /><div className="flex items-center gap-6"><div className="relative flex h-28 w-28 shrink-0 items-center justify-center rounded-full" style={{
              ...
              }}><div className="flex h-20 w-20 flex-col items-center justify-center rounded-full bg-card"><strong className="text-2xl text-foreground">82</strong><span className="text-[10px] text-muted-foreground">/ 100</span></div></div><div><span className="rounded-full border px-2 py-1 text-xs font-bold text-chart-4 bg-chart-4/10 border-chart-4/30">Healthy · +6</span><p className="mt-3 text-xs font-bold text-muted-foreground">Positive drivers</p><p className="mt-1 text-sm text-foreground">Revenue growth · Customer growth · Conversion improvement</p><p className="mt-3 text-xs font-bold text-muted-foreground">Watch</p><p className="mt-1 text-sm text-foreground">Advertising efficiency</p></div></div><button className="mt-5 text-sm font-bold text-foreground">View Business Health <ChevronRight className="inline" size={15} /></button></article><article className="rounded-xl border border-border bg-card p-5 shadow-sm"><SectionHeader title="Growth Intelligence" subtitle="Momentum is building across the funnel." /><div className="flex items-end justify-between"><div><p className="text-4xl font-bold tracking-tight text-foreground">91<span className="text-base font-medium text-muted-foreground">/100</span></p><p className="mt-1 text-sm font-semibold text-chart-4">↑ Growth score</p></div><Sparkline color="var(--chart-4)" /></div><div className="mt-5 grid grid-cols-2 gap-y-3 text-sm"><span className="text-muted-foreground">Revenue growth <strong className="float-right text-chart-4">+14.8%</strong></span><span className="text-muted-foreground">Customer growth <strong className="float-right text-chart-4">+11.4%</strong></span><span className="text-muted-foreground">Lead growth <strong className="float-right text-chart-4">+8.2%</strong></span><span className="text-muted-foreground">Conversion growth <strong className="float-right text-chart-4">+6.2%</strong></span></div><p className="mt-5 rounded-lg bg-chart-4/10 px-3 py-2.5 text-sm font-semibold text-chart-4">Customer acquisition is accelerating ahead of forecast</p><button className="mt-4 text-sm font-bold text-foreground">View Growth <ChevronRight className="inline" size={15} /></button></article></section>

          <section className="mb-9 grid gap-4 lg:grid-cols-2"><article className="rounded-xl border border-border bg-card p-5 shadow-sm"><SectionHeader title="Revenue Intelligence" /><div className="flex items-end justify-between"><div><p className="text-3xl font-bold text-foreground">€248,400</p><p className="mt-1 text-sm font-bold text-chart-4">+14.8% growth</p></div><Sparkline /></div><div className="mt-5 grid grid-cols-2 gap-3 text-sm"><div><p className="text-xs text-muted-foreground">Drivers</p><p className="mt-1 font-semibold">Direct sales · Recurring revenue</p></div><div><p className="text-xs text-muted-foreground">Forecast</p><p className="mt-1 font-semibold">€261,000 <span className="text-xs font-normal text-muted-foreground">estimated</span></p></div></div><p className="mt-4 text-sm text-chart-1">Advertising efficiency decline may impact acquisition revenue.</p><button className="mt-4 text-sm font-bold text-foreground">View Revenue <ChevronRight className="inline" size={15} /></button></article><article className="rounded-xl border border-border bg-card p-5 shadow-sm"><SectionHeader title="Customer Intelligence" /><div className="flex items-end justify-between"><div><p className="text-3xl font-bold text-foreground">4,821</p><p className="mt-1 text-sm font-bold text-chart-4">+11.4% customer growth</p></div><Users className="text-foreground" size={30} /></div><div className="mt-5 grid grid-cols-2 gap-4 text-sm"><div><span className="text-muted-foreground">Retention</span><strong className="float-right">87%</strong></div><div><span className="text-muted-foreground">Churn</span><strong className="float-right">3.2%</strong></div><div><span className="text-muted-foreground">LTV avg.</span><strong className="float-right">€1,240</strong></div><div><span className="text-muted-foreground">New this period</span><strong className="float-right">492</strong></div></div><p className="mt-4 rounded-lg bg-secondary px-3 py-2.5 text-sm font-semibold text-foreground">Retention has stabilized after 2 months of decline</p><button className="mt-4 text-sm font-bold text-foreground">View Customers <ChevronRight className="inline" size={15} /></button></article></section>

          <section className="mb-9 grid gap-4 lg:grid-cols-2"><article className="rounded-xl border border-border bg-card p-5 shadow-sm"><SectionHeader title="Sales Intelligence" /><p className="text-3xl font-bold">€842,000 <span className="text-sm font-medium text-muted-foreground">pipeline</span></p><div className="mt-5 grid grid-cols-2 gap-3 text-sm"><span className="text-muted-foreground">Open opportunities <strong className="float-right text-foreground">127</strong></span><span className="text-muted-foreground">Conversion rate <strong className="float-right text-foreground">24.8%</strong></span><span className="text-muted-foreground">Win rate <strong className="float-right text-foreground">31%</strong></span><span className="text-muted-foreground">Avg deal <strong className="float-right text-foreground">€6,630</strong></span><span className="text-muted-foreground">Velocity <strong className="float-right text-foreground">18 days</strong></span></div><p className="mt-5 rounded-lg bg-chart-4/10 px-3 py-2.5 text-sm font-semibold text-chart-4">Pipeline value increased 9.4% vs previous period</p><button className="mt-4 text-sm font-bold text-foreground">View Sales <ChevronRight className="inline" size={15} /></button></article><article className="rounded-xl border border-border bg-card p-5 shadow-sm"><SectionHeader title="Marketing Intelligence" /><div className="flex items-center justify-between"><div><p className="text-3xl font-bold">84<span className="text-sm font-medium text-muted-foreground">/100</span></p><p className="mt-1 text-sm font-bold text-chart-4">Good efficiency</p></div><BarChart3 className="text-foreground" size={30} /></div><div className="mt-5 grid grid-cols-2 gap-y-3 text-sm"><span className="text-muted-foreground">Lead generation <strong className="float-right text-chart-4">+12.4%</strong></span><span className="text-muted-foreground">Conversion <strong className="float-right text-chart-4">+6.2%</strong></span><span className="text-muted-foreground">SEO <strong className="float-right text-chart-4">Trending up</strong></span><span className="text-muted-foreground">GEO / AEO <strong className="float-right">Stable / Improving</strong></span></div><button className="mt-5 text-sm font-bold text-foreground">View Marketing <ChevronRight className="inline" size={15} /></button></article></section>

          <section className="mb-9 rounded-xl border border-border bg-card p-5 shadow-sm"><SectionHeader title="Advertising Intelligence" subtitle="Spend and efficiency across paid channels." /><div className="grid grid-cols-2 gap-5 md:grid-cols-5"><div><p className="text-xs text-muted-foreground">Spend</p><p className="mt-1 text-xl font-bold">€42,800</p></div><div><p className="text-xs text-muted-foreground">Revenue</p><p className="mt-1 text-xl font-bold">€154,080</p></div><div><p className="text-xs text-muted-foreground">ROAS</p><p className="mt-1 text-xl font-bold text-chart-5">3.6 <span className="text-xs font-medium">from 4.2</span></p></div><div><p className="text-xs text-muted-foreground">CPA</p><p className="mt-1 text-xl font-bold">€87</p></div><div><p className="text-xs text-muted-foreground">Conversions</p><p className="mt-1 text-xl font-bold">492</p></div></div><div className="mt-5 grid gap-3 md:grid-cols-3"><div className="rounded-lg bg-secondary p-3 text-sm"><span className="font-bold text-foreground">Best platform</span><p className="mt-1 text-foreground">Google Ads · ROAS 4.8</p></div><div className="rounded-lg bg-chart-5/10 p-3 text-sm"><span className="font-bold text-chart-5">Weakest campaign</span><p className="mt-1 text-chart-5">Meta Remarketing · ROAS 2.1</p></div><div className="rounded-lg bg-secondary p-3 text-sm text-foreground"><span className="font-bold">AI opportunity</span><p className="mt-1">Reallocating 15% from Meta to Google Search could improve ROAS by ~0.4.</p></div></div><button className="mt-5 text-sm font-bold text-foreground">View Advertising <ChevronRight className="inline" size={15} /></button></section>
