...
const plans: Plan[] = [
  { id: "ai", name: "AI", eyebrow: "Let Lulu run growth", description: "Give Lulu the authority to recommend, execute and automate the work across your workspace.", icon: WandSparkles, accent: "bg-[var(--secondary)] text-[var(--foreground)] border border-[var(--primary)]/20", features: ["AI insights and recommendations", "AI-assisted content and decisions", "Full automation of supported workflows", "Prepaid AI execution with fixed RMB packages", "5% commission on each Lulu-attributed sale"], limitations: "Autonomous execution starts when confirmed AI and advertising balances are available", price: LULU_AI_ANNUAL_PRICE, pricePeriod: "per year", cta: "Activate AI" },
];
