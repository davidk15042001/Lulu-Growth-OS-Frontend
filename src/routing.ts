...
export const routes = {
  ...
  app: {
    ...
    growth: "/app/growth",
    onlinePresence: "/app/online-presence",
    finance: "/app/finance",
    funds: "/app/pure-minute-5446",
    adSpend: "/app/sunny-minute-1092",
    connections: "/app/connections",
    website: "/app/online-presence",
    email: "/app/email",
...
const canonicalPathsBySlug: Readonly<Record<string, string>> = {
  ...
  "lulu-connected-apps-9011": routes.app.connections,
