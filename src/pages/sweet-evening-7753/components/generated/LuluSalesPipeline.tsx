  ...
  return <main className="min-h-screen bg-[var(--background)] text-foreground">
    <div className="flex min-h-screen">
      <aside className="hidden w-[232px] shrink-0 border-r border-border bg-[var(--sidebar)] px-4 py-5 lg:block">
        ...
        <div className="mt-[260px] rounded-xl border border-border bg-secondary p-3"><div className="mb-2 flex items-center gap-2 text-xs font-medium text-foreground"><Bot size={15} className="text-foreground" /> Lulu AI</div><p className="text-[11px] leading-5 text-muted-foreground">Your revenue copilot is ready to help.</p></div>
      </aside>
