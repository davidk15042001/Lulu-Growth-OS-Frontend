...
import { Activity, AlertTriangle, ArrowDown, ArrowUp, BarChart3, Bot, ChevronDown, ChevronRight, CircleCheck, Clock3, Download, ExternalLink, Filter, Menu, MoreHorizontal, Package, Search, Send, Settings2, Sparkles, Store, Users, X, Zap } from 'lucide-react';
...
const kpis: any[][] = [];
const products: any[][] = [];
const categories = [['Serums & Treatments', '—', '621', '1,248', '+22%', '34.5%'], ['Moisturisers', '—', '487', '918', '+14%', '25.4%'], ['Lip Products', '—', '394', '712', '+9%', '15.5%'], ['Eye Care', '—', '248', '489', '-2%', '13.7%'], ['Sun Care', '—', '197', '422', '+6%', '10.9%']];
