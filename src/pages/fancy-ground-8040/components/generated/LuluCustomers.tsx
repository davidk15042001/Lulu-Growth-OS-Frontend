...
export function LuluCustomers() {
  ...
  return <div className="min-h-screen bg-[var(--background)] font-sans text-[var(--foreground)]">
    ...
    <main className="lg:ml-[238px]">
      <header className="flex min-h-[74px] items-center justify-between border-b border-[var(--border)] bg-card px-5 py-4 sm:px-8"><div className="flex items-center gap-3"><button className="rounded-md p-2 hover:bg-sidebar lg:hidden" aria-label="Open navigation"><Menu size={19} /></button><div><div className="mb-1 flex items-center gap-2 text-[11px] font-medium text-[var(--muted-foreground)]"><span>Ecommerce</span><ChevronRight size={12} /><span className="text-[var(--muted-foreground)]">Customers</span></div><h1 className="text-[24px] font-bold tracking-[-0.035em]">Customers</h1><p className="mt-1 hidden text-[13px] text-[var(--muted-foreground)] sm:block">Manage and monitor customers across your connected ecommerce stores.</p></div></div><div className="flex items-center gap-2"><button className="rounded-lg border border-[var(--border)] bg-card p-2 text-[var(--muted-foreground)] hover:bg-card" aria-label="Refresh customers"><RefreshCw size={16} /></button><button className="rounded-lg border border-[var(--border)] p-2 text-[var(--muted-foreground)] hover:bg-card" aria-label="More actions"><Ellipsis size={17} /></button></div></header>
