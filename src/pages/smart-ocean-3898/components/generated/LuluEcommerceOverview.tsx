...
export function LuluEcommerceOverview() {
  ...
  const { items: orderRecords, loading: ordersLoading, error: ordersError, refresh: refreshOrders } = useLiveRecords('ecommerce_orders');
  const { items: customerRecords, loading: customersLoading, error: customersError, refresh: refreshCustomers } = useLiveRecords('ecommerce_customers');
  const { items: storeRecords, loading: storesLoading, error: storesError, refresh: refreshStores } = useLiveRecords('ecommerce_stores');
