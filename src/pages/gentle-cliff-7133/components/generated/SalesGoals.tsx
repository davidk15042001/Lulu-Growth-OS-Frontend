...
export function SalesGoals() {
  const { items: goalRecords, loading: goalsLoading, error: goalsError } = useLiveRecords('sales_goals');
  ...
  return <div className="min-h-screen bg-[var(--background)] text-foreground">
    ...
    <main className="lg:pl-[238px]"><header className="sticky top-0 z-10 flex min-h-[76px] flex-wrap items-center justify-between gap-4 border-b border-border bg-secondary px-5 py-4 backdrop-blur md:px-8"><div><div className="mb-1 flex items-center gap-2 text-xs font-medium text-muted-foreground"><span>Sales</span><span>/</span><span className="text-muted-foreground">Sales Goals</span></div><h1 className="text-xl font-bold tracking-tight text-foreground">Sales Goals</h1></div><div className="flex flex-wrap items-center gap-2"><button className="hidden rounded-lg border border-border px-3 py-2 text-sm font-medium text-foreground hover:bg-card md:block"><Upload size={14} className="mr-1.5 inline" />Import</button><button className="hidden rounded-lg border border-border px-3 py-2 text-sm font-medium text-foreground hover:bg-card md:block"><Download size={14} className="mr-1.5 inline" />Export</button><button aria-label="More actions" className="rounded-lg border border-border p-2 text-foreground"><MoreHorizontal size={18} /></button><button className="rounded-lg bg-primary px-3.5 py-2 text-sm font-semibold text-primary-foreground shadow-sm shadow-black/10 hover:bg-primary"><span>+ Create Goal</span></button></div></header><div className="mx-auto max-w-[1440px] px-5 py-7 md:px-8">
