...
const shipments = [{
  ...
  dot: 'bg-primary',
  carrier: 'DHL',
  tracking: 'DE-987654321',
  method: 'Express',
  status: 'In Transit',
  tone: 'blue',
  destination: 'Germany',
  updated: '10 Aug 14:30'
}, {
  id: 'SHP-10498',
  order: '#10498',
  ...
  dot: 'bg-primary',
  carrier: 'Royal Mail',
  tracking: 'RM-123456789GB',
  method: 'Standard',
  status: 'Delivered',
  tone: 'emerald',
  destination: 'United Kingdom',
  updated: '10 Aug 10:15'
}, {
  id: 'SHP-10501',
  order: '#10501',
  ...
  dot: 'bg-primary',
  carrier: 'FedEx',
  tracking: 'FX-246813579',
  method: 'Priority',
  status: 'Out for Delivery',
  tone: 'teal',
  destination: 'France',
  updated: '10 Aug 08:00'
}, {
  id: 'SHP-10488',
  order: '#10488',
  ...
  dot: 'bg-primary',
  carrier: 'DHL',
  tracking: 'DE-765432109',
  method: 'Express',
  status: 'Label Created',
  tone: 'sky',
  destination: 'Belgium',
  updated: '10 Aug 15:00'
}, {
  id: 'SHP-10460',
  order: '#10460',
  customer: 'Guest',
  ...
  tone: 'slate',
  destination: 'United Kingdom',
  updated: '10 Aug 14:00'
}];
const attention = [['SHP-10501', 'Failed delivery attempt - address issue', 'DHL', 'Lulu Store', 'Critical', '1 hour ago', 'red'], ['SHP-10488', 'Carrier exception - customs hold', 'FedEx', 'Lulu Store', 'High', '3 hours ago', 'orange'], ['SHP-10476', 'Long delay - last update 6 days ago', 'DPD', 'Style and Co', 'High', '6 days ago', 'orange'], ['SHP-10465', 'Missing tracking information', 'Unknown', 'Lulu Store', 'Medium', '2 days ago', 'amber'], ['SHP-10451', 'Shipment returned to sender', 'UPS', 'Style and Co', 'High', '1 day ago', 'orange']];
const delayed = [['SHP-10488', 'Priya Patel', 'Lulu Store', 'FedEx', 'FX-135792468', '4 Aug'], ['SHP-10476', 'David Lee', 'Style and Co', 'DPD', 'DPD-112233', '4 Aug ago'], ['SHP-10463', 'Lisa Brown', 'Lulu Store', 'UPS', '1Z-888BB20', '5 Aug'], ['SHP-10449', 'Tom Green', 'Lulu Store', 'DHL', 'DE-654321', '3 Aug']];
const failed = [['SHP-10501', 'Emma Wilson', 'DHL', 'DE-876543210', 'Address issue', '9 Aug'], ['SHP-10492', 'Mark Davis', 'FedEx', 'FX-111222333', 'Delivery refused', '8 Aug'], ['SHP-10483', 'Anna Kim', 'UPS', '1Z-777CC30', 'Recipient absent', '7 Aug'], ['SHP-10471', 'Guest', 'DHL', 'DE-543219', 'Address not found', '6 Aug']];
...
export const LuluShipping = () => {
  ...
  return <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] font-sans">
    <aside className="fixed inset-y-0 left-0 z-20 flex w-14 flex-col items-center bg-[var(--sidebar)] py-4 text-muted-foreground" aria-label="Primary navigation">
      ...
      <nav className="flex flex-1 flex-col items-center gap-2">{nav.map((Icon, i) => <button key={Icon.displayName || i} aria-label={i === 5 ? 'Ecommerce' : `Navigation ${i + 1}`} className={`flex h-9 w-9 items-center justify-center rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${i === 5 ? 'bg-secondary/20 text-foreground' : 'hover:bg-secondary hover:text-foreground'}`}><Icon size={18} strokeWidth={1.8} /></button>)}</nav>
