...
import { Bell, Bot, Check, ChevronDown, Download, Ellipsis, LayoutDashboard, Menu, Plus, Search, Settings, Sparkles, Target, Users, X } from 'lucide-react';
type Opp = any;
const opps: Opp[] = [['Enterprise Expansion', 'Nova Commerce', 'Maria Chen', 'David K', 'Negotiation', '€85,000', '72%', '25 Sep 2026', 'Healthy', 'High', 'Executive Meeting'], ['Cloud Migration Suite', 'DataStream AG', 'Lena Müller', 'Sarah C', 'Proposal', '€128,000', '45%', '15 Oct 2026', 'Needs Attention', 'High', 'Send Proposal'], ['Marketing Platform', 'Bluewave Ltd', 'James Park', 'Marcus H', 'Solution Fit', '€52,000', '60%', '1 Nov 2026', 'Healthy', 'Medium', 'Follow-up Call'], ['Analytics Dashboard', 'Vertex Corp', 'Tom Reyes', 'Priya N', 'Discovery', '€37,500', '35%', '20 Nov 2026', 'At Risk', 'High', 'Re-engage'], ['CRM Integration', 'NexGen Systems', 'Olivia Stone', 'Marcus H', 'Qualified', '€29,000', '50%', '5 Dec 2026', 'Healthy', 'Medium', 'Schedule Demo'], ['Sales Automation', 'GlobalTech Inc', 'Ravi Singh', 'Sarah C', 'Discovery', '€94,000', '28%', '31 Jan 2027', 'Needs Attention', 'Medium', 'Qualify Budget'], ['Strategic Partnership', 'Apex Ventures', 'Claire Dumont', 'David K', 'Commit', '€210,000', '85%', '10 Sep 2026', 'Healthy', 'High', 'Final Review'], ['Renewal + Expansion', 'Pinnacle GmbH', 'Klaus Bauer', 'Priya N', 'Negotiation', '€67,000', '78%', '30 Sep 2026', 'Healthy', 'High', 'Contract Review']];
const metrics = [['Total Opportunities', '248', '+12.4% ↑', 'Recorded'], ['New Opportunities', '34', '+8.2% ↑', 'Recorded'], ['Open Opportunities', '186', '+9.6% ↑', 'Calculated'], ['Qualified', '142', '+11.8% ↑', 'Recorded'], ['Opportunity Value', '€6,240,000', '+21.9% ↑', 'Recorded'], ['Weighted Value', '€2,620,800', '+18.4% ↑', 'Calculated'], ['Win Probability', '42.0%', '+3.2pp ↑', 'Calculated'], ['At Risk', '18', 'Needs Review', 'AI']];
const funnel = [['Qualified', '312 opps · €7,800,000', '100%'], ['Discovery', '248 opps · €6,240,000', '79.5%'], ['Solution Fit', '186 opps · €4,650,000', '75.0%'], ['Proposal', '124 opps · €3,100,000', '66.7%'], ['Negotiation', '68 opps · €1,836,000', '54.8%'], ['Commit', '42 opps · €1,134,000', '61.8%']];
const actions = [['Schedule Follow-up', 'Enterprise Expansion', 'No executive meeting confirmed. High probability deal.'], ['Send Proposal', 'Cloud Migration Suite', 'Proposal stage 12 days. Client last engaged 2 days ago.'], ['Re-engage Customer', 'Analytics Dashboard', 'No activity 8 days. Probability declining.'], ['Add Decision Maker', 'GlobalTech Inc', 'No confirmed decision maker on record.']];
