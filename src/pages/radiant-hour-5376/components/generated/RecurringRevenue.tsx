...
<div className="collapsed-states"><button>Empty state <ChevronDown size={14} /></button><button>Limited data <ChevronDown size={14} /></button><button>Errors & sync status <ChevronDown size={14} /></button></div></div></main></div>;
}
