...
type Opp = any;
const opps: Opp[] = [['Enterprise Expansion', 'Connected account', 'Maria Chen', 'David K', 'Negotiation', '€85,000', '72%', '25 Sep 2026', 'Healthy', 'High', 'Executive Meeting'], ['Cloud Migration Suite', 'DataStream AG', 'Lena Müller', 'Sarah C', 'Proposal', '€128,000', '45%', '15 Oct 2026', 'Needs Attention', 'High', 'Send Proposal'], ['Marketing Platform', 'Bluewave Ltd', 'Workspace member', 'Marcus H', 'Solution Fit', '€52,000', '60%', '1 Nov 2026', 'Healthy', 'Medium', 'Follow-up Call'], ['Analytics Dashboard', 'Vertex Corp', 'Tom Reyes', 'Priya N', 'Discovery', '€37,500', '35%', '20 Nov 2026', 'At Risk', 'High', 'Re-engage'], ['CRM Integration', 'NexGen Systems', 'Olivia Stone', 'Marcus H', 'Qualified', '€29,000', '50%', '5 Dec 2026', 'Healthy', 'Medium', 'Schedule Workspace'], ['Sales Automation', 'GlobalTech Inc', 'Ravi Singh', 'Sarah C', 'Discovery', '€94,000', '28%', '31 Jan 2027', 'Needs Attention', 'Medium', 'Qualify Budget'], ['Strategic Partnership', 'Apex Ventures', 'Claire Dumont', 'David K', 'Commit', '€210,000', '85%', '10 Sep 2026', 'Healthy', 'High', 'Final Review'], ['Renewal + Expansion', 'Pinnacle GmbH', 'Klaus Bauer', 'Priya N', 'Negotiation', '€67,000', '78%', '30 Sep 2026', 'Healthy', 'High', 'Contract Review']];
const metrics: any[][] = [];
const funnel: any[][] = [];
const actions: any[][] = [];
