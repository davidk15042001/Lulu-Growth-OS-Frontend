  ...
  return <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] font-sans">
    ...
    <main className="ml-14 min-w-0 px-6 py-6 lg:px-8">
      <header className="mb-6 flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        ...
        <div className="flex flex-wrap gap-2"><button className="inline-flex items-center gap-2 rounded-lg border border-border bg-secondary px-3 py-2 text-sm font-medium text-foreground hover:bg-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"><Sparkles size={16} />Ask Lulu AI</button><span className="inline-flex items-center rounded-lg border border-border bg-card px-3 py-2 text-sm text-muted-foreground">Use Update in the navigation bar</span><button className="inline-flex items-center gap-2 rounded-lg border bg-card px-3 py-2 text-sm hover:bg-card"><Download size={15} />Export</button><button aria-label="More actions" className="rounded-lg border bg-card p-2 hover:bg-secondary"><MoreHorizontal size={17} /></button></div>
      </header>
