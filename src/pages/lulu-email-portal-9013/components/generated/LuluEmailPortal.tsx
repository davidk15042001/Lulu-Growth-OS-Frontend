  ...
  return <main className="email-page">
    <header className="email-header">
      ...
      <div className="email-header__actions">
        {activeAccount && <select value={accountId} onChange={(event) => { setAccountId(event.target.value); setActiveThread(null); }} aria-label={t('Email account')}>{accounts.map((account) => <option key={account.id} value={account.id} translate="no">{account.emailAddress}</option>)}</select>}
