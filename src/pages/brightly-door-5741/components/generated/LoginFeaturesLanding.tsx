import { ArrowRight, BarChart3, Check, FileText, Globe2, Link2, LockKeyhole, Search, Settings2, Sparkles, Store, Users, Workflow, Zap } from 'lucide-react';
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16 sm:px-10 lg:px-16 lg:py-24">
        <div className="grid items-center gap-14 lg:grid-cols-[1.02fr_.98fr] lg:gap-20">
          <div>
            ...
            <h2 id="lulu-platform-title" className="mt-7 max-w-3xl text-4xl font-semibold tracking-[-.04em] text-slate-950 sm:text-5xl lg:text-6xl">{t('Turn business signals into confident action.')}</h2>
