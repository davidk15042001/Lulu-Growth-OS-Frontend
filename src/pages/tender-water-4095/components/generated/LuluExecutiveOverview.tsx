...
export const LuluExecutiveOverview = () => {
  ...
  <section className="mb-9 rounded-xl border border-border bg-card p-5 shadow-sm"><Header title="Revenue & Growth" subtitle="Momentum, forecast and the drivers behind revenue performance." /><div className="grid gap-6 md:grid-cols-2"><div><p className="text-4xl font-bold tracking-tight">€248,400</p><Badge kind="green">+14.8% growth ↑</Badge><p className="mt-5 text-xs text-muted-foreground">Revenue forecast · next 30 days</p><p className="mt-1 text-2xl font-bold">€261,000 <Badge kind="purple"><Sparkles size={10} />AI Forecast · Estimated</Badge></p><p className="mt-3 text-sm text-muted-foreground">Revenue increased primarily due to stronger customer acquisition and higher average order value.</p></div><div className="flex items-center justify-between rounded-xl bg-card p-5"><div><p className="text-xs text-muted-foreground">Growth score</p><p className="text-4xl font-bold">91<span className="text-sm font-normal text-muted-foreground">/100</span></p><p className="mt-2 text-sm font-bold text-chart-4">Customer growth +11.4%</p><p className="mt-1 text-sm font-bold text-chart-4">Sales growth +8.7%</p></div><div className="flex h-24 w-24 items-center justify-center rounded-full" style={{
                background: 'conic-gradient(var(--chart-4) 0 91%,var(--secondary) 91% 100%)'
              }}><div className="flex h-16 w-16 items-center justify-center rounded-full bg-card text-lg font-bold">91</div></div></div></div><div className="mt-6 rounded-lg bg-card p-3"><svg viewBox="0 0 800 170" className="h-40 w-full" role="img" aria-label="Revenue over time chart"><path d="M10 140 C90 128 120 100 180 112 S280 80 340 95 S430 45 500 68 S590 28 660 48 S730 20 790 30 L790 155 L10 155Z" fill="var(--border)" /><path d="M10 140 C90 128 120 100 180 112 S280 80 340 95 S430 45 500 68 S590 28 660 48 S730 20 790 30" fill="none" stroke="var(--chart-3)" strokeWidth="3" /><path d="M10 145 C120 130 190 125 280 110 S440 102 530 91 S680 74 790 62" fill="none" stroke="var(--muted-foreground)" strokeWidth="2" strokeDasharray="7 7" /></svg><div className="flex justify-between text-[10px] text-muted-foreground"><span>1 Jun</span><span>15 Jun</span><span>30 Jun</span></div></div><div className="mt-4 flex flex-wrap items-center gap-2"><Badge kind="purple"><Sparkles size={11} />AI Inferred</Badge><span className="rounded-md bg-card px-2 py-1 text-xs text-muted-foreground">AOV +3.2%</span><span className="rounded-md bg-card px-2 py-1 text-xs text-muted-foreground">New customers +492</span><Button>View Revenue</Button><Button>View Growth</Button></div></section>
  <section className="mb-9 grid gap-4 lg:grid-cols-2"><article className="rounded-xl border border-border bg-card p-5 shadow-sm"><Header title="Customers & Sales" /><div className="grid grid-cols-2 gap-4"><div><p className="text-3xl font-bold">4,821</p><Badge kind="green">+11.4%</Badge><dl className="mt-5 space-y-2 text-sm"><div className="flex justify-between"><dt className="text-muted-foreground">New this period</dt><dd className="font-bold">492</dd></div><div className="flex justify-between"><dt className="text-muted-foreground">Retention</dt><dd className="font-bold">87%</dd></div><div className="flex justify-between"><dt className="text-muted-foreground">Churn</dt><dd className="font-bold">3.2%</dd></div><div className="flex justify-between"><dt className="text-muted-foreground">LTV avg.</dt><dd className="font-bold">€1,240</dd></div></dl></div><div><p className="text-3xl font-bold">€842K</p><p className="text-xs text-muted-foreground">Pipeline</p><dl className="mt-5 space-y-2 text-sm"><div className="flex justify-between"><dt className="text-muted-foreground">Open deals</dt><dd className="font-bold">127</dd></div><div className="flex justify-between"><dt className="text-muted-foreground">Win rate</dt><dd className="font-bold">31%</dd></div><div className="flex justify-between"><dt className="text-muted-foreground">Avg deal</dt><dd className="font-bold">€6,630</dd></div><div className="flex justify-between"><dt className="text-muted-foreground">Velocity</dt><dd className="font-bold">18 days</dd></div></dl></div></div><p className="mt-5 rounded-lg bg-chart-4/10 p-3 text-sm font-semibold text-chart-4">AI Inferred · Customer growth increased 11.4% while retention remained stable.</p></article><article className="rounded-xl border border-border bg-card p-5 shadow-sm"><Header title="Marketing & Advertising" /><div className="grid grid-cols-2 gap-4"><div><p className="text-3xl font-bold">84<span className="text-sm font-normal text-muted-foreground">/100</span></p><Badge kind="green">Good</Badge><p className="mt-5 text-sm text-muted-foreground">Lead gen <strong className="float-right text-chart-4">+12.4%</strong></p><p className="mt-2 text-sm text-muted-foreground">Conversion <strong className="float-right text-chart-4">+6.2%</strong></p><p className="mt-2 text-sm text-muted-foreground">Best channel <strong className="float-right">Google Ads</strong></p></div><div><p className="text-sm text-muted-foreground">Spend <strong className="float-right">€42,800</strong></p><p className="mt-2 text-sm text-muted-foreground">Revenue <strong className="float-right">€154,080</strong></p><p className="mt-4 text-3xl font-bold">3.6 <Badge kind="red">-14% ↓</Badge></p><p className="mt-1 text-xs text-muted-foreground">ROAS · previous 4.2</p></div></div><div className="mt-5 grid gap-2 sm:grid-cols-2"><span className="rounded-lg bg-secondary p-3 text-sm text-foreground"><strong>Best platform</strong><br />Google Ads · ROAS 4.8</span><span className="rounded-lg bg-chart-5/10 p-3 text-sm text-chart-5"><strong>Weakest</strong><br />Meta Remarketing · ROAS 2.1</span></div><p className="mt-4 text-sm text-muted-foreground">AI Inferred · Google Ads generated the strongest return, while Meta advertising efficiency declined.</p></article></section>
  <section className="mb-9 rounded-xl border border-border bg-card p-5 shadow-sm"><Header title="Financial Performance" /><div className="grid grid-cols-2 gap-5 md:grid-cols-4">{[['Revenue', '€248,400'], ['Gross Profit', '€106,316'], ['Gross Margin', '42.8%'], ['Previous period', '€216,400']].map(row => <div key={row[0]}><p className="text-xs text-muted-foreground">{row[0]}</p><p className="mt-1 text-xl font-bold">{row[1]}</p><p className="text-xs text-foreground">↑ Observed</p></div>)}</div><p className="mt-5 text-xs text-muted-foreground">Observed data from Finance System</p></section>
  <section className="mb-9 grid gap-4 lg:grid-cols-2"><article className="rounded-xl border border-border bg-card p-5 shadow-sm"><Header title="Operational Performance" /><div className="grid grid-cols-2 gap-4 text-sm"><p className="text-muted-foreground">Efficiency <strong className="float-right text-foreground">Good</strong></p><p className="text-muted-foreground">Fulfillment <strong className="float-right">97.2%</strong></p><p className="text-muted-foreground">Avg processing <strong className="float-right">1.4 days</strong></p><p className="text-muted-foreground">Support volume <strong className="float-right">Stable</strong></p></div></article><article className="rounded-xl border border-border bg-card p-5 shadow-sm"><Header title="Product Performance" action="View Products" /><div className="space-y-3 text-sm">{[['Product A', '€82,400', '+18%', 'Top product'], ['Product B', '€46,210', '+28%', 'Fastest growing'], ['Product C', '€21,600', '-12%', 'Attention']].map(row => <div key={row[0]} className="grid grid-cols-[1fr_auto_auto] items-center gap-3 border-b border-border pb-2 last:border-0"><strong>{row[0]}</strong><span>{row[1]}</span><span className={row[2].startsWith('-') ? 'text-chart-1' : 'text-foreground'}>{row[2]} · {row[3]}</span></div>)}</div></article></section>
