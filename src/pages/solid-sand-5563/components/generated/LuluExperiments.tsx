...
export function LuluExperiments() {
  ...
  <aside className="fixed inset-y-0 left-0 z-20 hidden w-16 flex-col items-center border-r border-border bg-[var(--sidebar)] py-4 md:flex"><div className="mb-8 flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary text-lg font-black text-primary-foreground">L</div><nav className="flex flex-1 flex-col items-center gap-5 text-muted-foreground"><button aria-label="Dashboard"><LayoutDashboard size={19} /></button><button className="flex h-10 w-10 items-center justify-center rounded-xl bg-secondary/15 text-foreground" aria-label="Experiments"><FlaskConical size={19} /></button><button aria-label="Campaigns"><Target size={19} /></button><button aria-label="Audience"><Users size={19} /></button><button aria-label="Insights"><Lightbulb size={19} /></button></nav><button className="text-foreground" aria-label="Settings"><Settings2 size={19} /></button></aside>
