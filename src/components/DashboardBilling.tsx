...
type Plan = { id: PlanId; name: string; eyebrow: string; description: string; icon: typeof Eye; accent: string; features: string[]; limitations: string; price: string; pricePeriod: string; cta: string };
...
const plans: Plan[] = [
  ...
  { id: "test", name: "Test", eyebrow: "Full AI access for verification", description: "Run the complete AI package on a 1 RMB subscription for final end-to-end verification.", icon: WandSparkles, accent: "bg-[var(--secondary)] text-[var(--foreground)] border border-dashed border-[var(--primary)]/40", features: ["Everything in AI", "Full AI analysis, recommendations and actions", "Full automation of supported workflows", "Ideal for production checkout verification"], limitations: "This is a paid verification plan at 1 RMB per year", price: "RMB 1", pricePeriod: "per year", cta: "Choose Test" },
];
