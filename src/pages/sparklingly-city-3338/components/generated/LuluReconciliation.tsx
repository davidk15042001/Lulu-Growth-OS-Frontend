...
const rightRecords: Array<readonly [string, string, string, string, string, string]> = [];
const unmatched: any[][] = [];
const suggestions: Array<readonly [string, string, string, string, string, string]> = [];
const rules = [['Exact Amount Match', 'Amount equals · Currency equals', '1', 'Active', 'Today'], ['Date Tolerance ±3 Days', 'Date within 3 calendar days', '2', 'Active', 'Not available'], ['Reference Match', 'Reference contains invoice ID', '3', 'Active', 'Not available'], ['External ID Match', 'External ID is present', '4', 'Inactive', 'Not available'], ['Description Similarity', 'Description similarity > —', '5', 'Active', 'Not available']];
const history: any[][] = [];
