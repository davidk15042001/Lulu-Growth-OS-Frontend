...
const styles = `.lulu-language-shell{all:initial;position:fixed;right:max(18px,env(safe-area-inset-right));bottom:max(18px,env(safe-area-inset-bottom));z-index:2147483002;direction:ltr;color:#171717;font:400 13px/1.35 Poppins,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}.lulu-language-shell *{box-sizing:border-box}.lulu-language-launch{display:flex;align-items:center;justify-content:center;gap:6px;min-width:56px;height:40px;border:1px solid #d6d6d1;border-radius:999px;background:#fff;color:#171717;padding:0 12px;box-shadow:0 10px 30px rgba(0,0,0,.16);font:700 12px/1 Poppins,ui-sans-serif,system-ui,sans-serif;cursor:pointer}.lulu-language-menu{position:absolute;right:0;bottom:48px;width:236px;overflow:hidden;border:1px solid #d6d6d1;border-radius:14px;background:#fff;box-shadow:0 18px 54px rgba(0,0,0,.22)}.lulu-language-title{padding:12px 13px 9px;border-bottom:1px solid #ecece8;color:#686864;font-size:10px;font-weight:800;letter-spacing:.1em;text-transform:uppercase}.lulu-language-list{max-height:min(430px,calc(100vh - 150px));overflow-y:auto;padding:6px}.lulu-language-option{position:relative;display:grid;width:100%;grid-template-columns:1fr auto;grid-template-rows:auto auto;gap:1px 8px;border:0;border-radius:9px;background:transparent;color:#171717;padding:8px 30px 8px 9px;text-align:left;cursor:pointer}.lulu-language-option:hover,.lulu-language-option:focus-visible{background:#f2f2ef;outline:0}.lulu-language-option:disabled{color:#969690;cursor:not-allowed}.lulu-language-option:disabled:hover{background:transparent}.lulu-language-option[aria-checked=true]{background:#eaf7f3}.lulu-language-option>span{grid-column:1;font-size:13px;font-weight:650}.lulu-language-option>small{grid-column:1;color:#777772;font-size:10px}.lulu-language-option>svg{position:absolute;right:9px;top:50%;color:#087a5b;transform:translateY(-50%)}@media (max-width:1100px),(max-height:760px){.lulu-language-shell{right:max(12px,env(safe-area-inset-right));bottom:max(12px,env(safe-area-inset-bottom))}.lulu-language-launch{min-width:44px;height:36px;padding:0 10px;border-radius:12px;box-shadow:0 8px 22px rgba(0,0,0,.14)}.lulu-language-launch span{font-size:11px}.lulu-language-menu{width:min(220px,calc(100vw - 24px));bottom:42px}}`;
