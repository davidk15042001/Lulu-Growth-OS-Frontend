...
const CampaignDetailWorkspace = () => {
  return <section className="mt-8 border-t border-[var(--border)] pt-4" aria-labelledby="campaign-detail-heading">
    <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between"><div className="flex items-center gap-2 text-[12px] text-[var(--muted-foreground)]"><ArrowLeft size={14} /><span>Campaigns / Summer Growth Campaign</span></div><div className="flex flex-wrap items-center gap-2"><button className="rounded-md px-2.5 py-1.5 text-[13px] text-[var(--muted-foreground)] hover:bg-[var(--card)]">Edit Campaign</button><button className="rounded-md px-2.5 py-1.5 text-[13px] text-[var(--muted-foreground)] hover:bg-[var(--card)]">Duplicate</button><button className="rounded-md px-2.5 py-1.5 text-[13px] text-[var(--muted-foreground)] hover:bg-[var(--card)]">Archive</button></div></div>
